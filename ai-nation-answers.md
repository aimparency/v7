...
## Where
Berlin and Memmingen

## Equity
50%-50% between the 2 founders. Or 1/3 for each founder and ASI itself when legally possible. 
...
## How would you categorize your innovation
Radical Innovation
...
Manus (acquired by Meta for $2B) - General-purpose autonomous agent for complex tasks
OpenAI ChatGPT Agent/Operator - Multi-step task automation
...
A friend of mine, David, is building solar plants. 
This involves some communication with contractors and calculations and some shifting of capital. 
Would be nice if we could help him automate this.
...
# page 10
## What do you want to achieve within the first 90 days of the program?*
Connection to open router. 
Build Integrations to real world APIs (maybe build a repository for that). 
First paying customer. 
Release the graph part for free. 
Cooperating with AI on it costs (subscription/pay per usage, or connect your own)

## What do you want to achieve during the next phase after these 90 days?*
Towards ASI, keep using the system to develop the system until the system develops itself. 
